...
const Partnership = () => {
  ...
  const withdrawalRequestActions = () => (
    <button className="bg-yellow-400 text-black px-2 py-1 rounded-md hover:bg-yellow-500 transition">
      View
    </button>
  );
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          ...
          {isCreateMode ? (
            ...
            >
              ...
              <div className="py-2 px-3 bg-white rounded shadow-sm mt-3">
            ...
            <>
              ...
              <button
                ...
                className="absolute top-3 right-3 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white font-bold text-2xl"
