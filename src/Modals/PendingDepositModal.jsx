      ...
      <div className="max-h-[470px] overflow-y-auto p-2">
        <div className={`rounded-xl shadow-lg p-6 border ${cardBg}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <Info label="Transaction Type" value={transaction_type} labelText={labelText} valueText={valueText} />
            <Info label="Source" value={source} labelText={labelText} valueText={valueText} />

            {/* Status */}
            <div className="flex flex-col">
              <span className={`text-sm ${labelText}`}>Status</span>
              <span
          ...
          {/* Description */}
          <div className="mt-6">
            <p className={`font-semibold mb-1 ${labelText}`}>Description</p>
            <p className={`p-3 rounded-lg border text-sm ${descBg} ${labelText}`}>
